    ...
    return (
        <div className='flex flex-col items-center gap-4 justify-center w-3/4 py-7'>
            ...
            <div className='flex items-center gap-3 md:gap-4 ml-auto'>
                ...
                <div className='flex items-center gap-2'>
                    <button className='font-medium rounded-lg active:underline' onClick={handleSortDate}>Data</button>
                    <button className='font-medium rounded-lg active:underline' onClick={handleSortAbc}>Nom</button>
                    <span>|</span>
                    <button className='text-sm active:underline' onClick={handleRestartOrder}>Per defecte</button>
                </div>
            </div>
            <div className='w-full min-h-[154.25px]'>
